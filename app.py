...
# app.py (Bản vá dứt điểm lỗi 404 bằng cấu trúc Model ID chính thức của thư viện google-genai)
from google import genai
from google.genai import errors
import streamlit as st
...
if phan_he == "Trợ lý Giảng dạy (Giáo viên)":
    ...
    if menu == "1. Thiết kế KHBD": 
        ...
        render_exam_designer_section(lambda p, m: run_ai_prompt_safe(p, m))
